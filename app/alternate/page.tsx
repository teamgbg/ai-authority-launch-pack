      ...
      <main className="relative">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            ...
            {/* Video Overlay for better text readability - transitions to dark */}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-6xl pb-24">
            <div className="grid gap-8 sm:grid-cols-3">
              <div className="group rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-8 transition-all duration-300 hover:border-[#F83600]/30 hover:shadow-lg hover:bg-white/10">
              ...
              <div className="group rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-8 transition-all duration-300 hover:border-[#F83600]/30 hover:shadow-lg hover:bg-white/10">
                ...
                <h3 className="mb-2 text-lg font-semibold text-white">Tailored to You</h3>
                <p className="text-sm leading-relaxed text-white/70">
              ...
              <div className="group rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-8 transition-all duration-300 hover:border-[#F83600]/30 hover:shadow-lg hover:bg-white/10">
                ...
                <h3 className="mb-2 text-lg font-semibold text-white">Ready to Use</h3>
                <p className="text-sm leading-relaxed text-white/70">
